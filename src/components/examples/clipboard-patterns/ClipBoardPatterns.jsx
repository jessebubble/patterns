...
export function ClipBoardPatterns() {
    return (
        <>
            <Container className="">
                            ...
                            <Border className="grid grid-cols-3 gap-x-8 gap-y-8 pt-16">
                                <div className="col-span-full sm:flex sm:items-center sm:justify-between sm:gap-x-8 lg:col-span-1 lg:block">
                                    <div className="sm:flex sm:items-center sm:gap-x-6 lg:block">
                                        <ClipboardIcon className="h-12 w-12 flex-none text-neutral-950" />
                                ...
                                <div className="col-span-full lg:col-span-2 lg:max-w-2xl">
                                    ...
                                    <div className="mt-6 space-y-6 text-base text-neutral-600">
                                        <p>
                                            Welcome to our growing collection of clipboad patterns. These patterns demonstrate considerations for accessibility, user preferences 
